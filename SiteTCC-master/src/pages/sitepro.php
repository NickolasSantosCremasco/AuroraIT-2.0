...
<body>
    ...
    <div class="container section-feature">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <h6 class="text-uppercase text-light">Site Profissional</h6>
                <h1 class="fw-bold text-light">Alcance Resultados com uma Presença Digital Completa</h1>
                <p class="text-light">O Plano Profissional é ideal para empresas que precisam de um site completo com alto desempenho. Inclui blog integrado, SEO e Analytics para acompanhamento de resultados, além de hospedagem e domínio inclusos.</p>
                <p class="text-light">Este plano é perfeito para quem busca profissionalismo, escalabilidade e presença digital estratégica. Uma solução avançada que entrega performance, visibilidade e suporte completo para negócios consolidados ou em expansão.</p>


                <div class="row g-4">
                    <div class="col-6">
                        <div><strong class="text-light">Premium Suites</strong><br><small class="text-light">Panoramic city views</small></div>
                    </div>
                    <div class="col-6">
                        <div><strong class="text-light">Award-Winning Service</strong><br><small class="text-light">Exceeds every expectation</small></div>
                    </div>
                    <div class="col-6">
                        <div><strong class="text-light">Prime Location</strong><br><small class="text-light">Cultural district</small></div>
                    </div>
                    <div class="col-6">
                        <div><strong class="text-light">Michelin Dining</strong><br><small class="text-light">Renowned chefs</small></div>
                    </div>
                </div>

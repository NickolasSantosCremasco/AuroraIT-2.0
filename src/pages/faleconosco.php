        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8">
                    <h3 class="fs-5 mb-2 text-secondary text-uppercase">Entre em contato</h3>
                    <h2 class="display-5 mb-4 mb-md-5 mb-xl-8">Para retirar todas as suas dúvidas sobre nossos serviços,
                    ...
                    <div class="border rounded-3 overflow-hidden">
                        <form action="#!">
                            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                ...
                                <div class="col-12">
                                    <label for="planType" class="form-label">Se interessou por um dos planos?</label>
                                    <select class="form-select" name="planType" id="planType" required>
                                        ...
                                        <option value="Plano Avançado">Plano Avançado</option>
                                    </select>
                                </div>
                                <div class="col-12">
                                    <label for="serviceType" class="form-label">Se interessou apenas por um serviço em
                                        específico?</label>
